...
real                                     :: pre_sh_flx
real                                     :: pre_sh_flx_tend
real                                     :: pre_lh_flx
real                                     :: pre_lh_flx_tend
real                                     :: pre_albedo
real                                     :: pre_albedo_tend
real                                     :: pre_tsk
real                                     :: pre_tsk_tend
integer                                  :: num_modes_aer
real                                     :: rm_aer1
real                                     :: rm_aer1_tend
real                                     :: rm_aer2
real                                     :: rm_aer2_tend
...
real                                     :: sig_aer4_tend
real                                     :: hygro_aer1
real                                     :: hygro_aer1_tend
real                                     :: hygro_aer2
real                                     :: hygro_aer2_tend
real                                     :: hygro_aer3
real                                     :: hygro_aer3_tend
real                                     :: hygro_aer4
real                                     :: hygro_aer4_tend
integer                                  :: crm_stat_count
real                                     :: prev_stat_secs
real                                     :: cst_cldlow
real                                     :: cst_cldtot
real                                     :: cst_lwp
...
real                                     :: crm_lon
integer                                  :: crm_stretch
integer                                  :: crm_num_pert_layers
integer                                  :: crm_pert_random_seed
real                                     :: crm_pert_amp
real                                     :: crm_init_ccn
integer                                  :: crm_lupar_opt
real                                     :: crm_znt
real                                     :: crm_emiss
real                                     :: crm_thc
real                                     :: crm_mavail
integer                                  :: crm_force_opt
integer                                  :: crm_th_adv_opt
integer                                  :: crm_th_rlx_opt
integer                                  :: crm_qv_adv_opt
integer                                  :: crm_qv_rlx_opt
integer                                  :: crm_adj_uv_opt
integer                                  :: crm_uv_rlx_opt
integer                                  :: crm_vert_adv_opt
integer                                  :: crm_wcpa_opt
integer                                  :: crm_num_force_layers
real                                     :: crm_tau_s
real                                     :: crm_tau_m
integer                                  :: crm_flx_opt
real                                     :: crm_sh_flx
...
real                                     :: crm_flx_ct
real                                     :: crm_flx_psfcpa
integer                                  :: crm_albedo_opt
real                                     :: crm_albedo
integer                                  :: crm_tsk_opt
real                                     :: crm_tsk
integer                                  :: crm_ust_opt
real                                     :: crm_ust
integer                                  :: crm_init_tke_opt
real                                     :: crm_init_tke
integer                                  :: crm_cgilsrad_re_opt
integer                                  :: crm_morr_act_opt
real                                     :: crm_mp_nc
integer                                  :: crm_num_aer_layers
integer                                  :: crm_morr_hygro_opt
real                                     :: crm_morr_hygro
integer                                  :: crm_stat_opt
real                                     :: crm_stat_sample_interval_s
integer                                  :: chem_opt
...
real      ,DIMENSION(:)       ,POINTER   :: u_ls
real      ,DIMENSION(:)       ,POINTER   :: u_ls_tend
real      ,DIMENSION(:)       ,POINTER   :: v_ls
real      ,DIMENSION(:)       ,POINTER   :: v_ls_tend
real      ,DIMENSION(:)       ,POINTER   :: w_ls
real      ,DIMENSION(:)       ,POINTER   :: w_ls_tend
real      ,DIMENSION(:)       ,POINTER   :: inv_tau_s
real      ,DIMENSION(:)       ,POINTER   :: inv_tau_m
real      ,DIMENSION(:)       ,POINTER   :: th_adv
real      ,DIMENSION(:)       ,POINTER   :: th_adv_tend
real      ,DIMENSION(:)       ,POINTER   :: th_rlx
real      ,DIMENSION(:)       ,POINTER   :: th_rlx_tend
real      ,DIMENSION(:)       ,POINTER   :: qv_adv
real      ,DIMENSION(:)       ,POINTER   :: qv_adv_tend
real      ,DIMENSION(:)       ,POINTER   :: qv_rlx
real      ,DIMENSION(:)       ,POINTER   :: qv_rlx_tend
real      ,DIMENSION(:)       ,POINTER   :: z_ls
real      ,DIMENSION(:)       ,POINTER   :: z_ls_tend
real      ,DIMENSION(:)       ,POINTER   :: na_aer1
real      ,DIMENSION(:)       ,POINTER   :: na_aer1_tend
real      ,DIMENSION(:)       ,POINTER   :: na_aer2
real      ,DIMENSION(:)       ,POINTER   :: na_aer2_tend
real      ,DIMENSION(:)       ,POINTER   :: na_aer3
real      ,DIMENSION(:)       ,POINTER   :: na_aer3_tend
real      ,DIMENSION(:)       ,POINTER   :: na_aer4
real      ,DIMENSION(:)       ,POINTER   :: na_aer4_tend
real      ,DIMENSION(:)       ,POINTER   :: z_aer
real      ,DIMENSION(:)       ,POINTER   :: z_aer_tend
real      ,DIMENSION(:)       ,POINTER   :: na_aer1_grd
real      ,DIMENSION(:)       ,POINTER   :: na_aer2_grd
real      ,DIMENSION(:)       ,POINTER   :: na_aer3_grd
real      ,DIMENSION(:)       ,POINTER   :: na_aer4_grd
real      ,DIMENSION(:,:,:)   ,POINTER   :: rulsten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rvlsten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rthlsten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqvlsten
real      ,DIMENSION(:,:,:)   ,POINTER   :: w_dthdz
real      ,DIMENSION(:,:,:)   ,POINTER   :: w_dqvdz
real      ,DIMENSION(:,:,:)   ,POINTER   :: w_dudz
real      ,DIMENSION(:,:,:)   ,POINTER   :: w_dvdz
real      ,DIMENSION(:)       ,POINTER   :: thdt_lshor
real      ,DIMENSION(:)       ,POINTER   :: qvdt_lshor
real      ,DIMENSION(:)       ,POINTER   :: thdt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: qvdt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: udt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: vdt_lsrlx
real      ,DIMENSION(:,:,:)   ,POINTER   :: effcs
real      ,DIMENSION(:,:,:)   ,POINTER   :: diffk
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwf0
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwf1
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwf2
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwf3
real      ,DIMENSION(:,:)     ,POINTER   :: zi_qt8
real      ,DIMENSION(:,:,:)   ,POINTER   :: sedfqc
real      ,DIMENSION(:,:,:)   ,POINTER   :: sedfqr
real      ,DIMENSION(:,:,:)   ,POINTER   :: qvdt_pr
real      ,DIMENSION(:,:,:)   ,POINTER   :: qvdt_cond
real      ,DIMENSION(:,:,:)   ,POINTER   :: qcdt_pr
real      ,DIMENSION(:,:,:)   ,POINTER   :: qcdt_sed
real      ,DIMENSION(:,:,:)   ,POINTER   :: qrdt_sed
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwupfd
real      ,DIMENSION(:,:,:)   ,POINTER   :: lwdnfd
real      ,DIMENSION(:,:,:)   ,POINTER   :: swupfd
real      ,DIMENSION(:,:,:)   ,POINTER   :: swdnfd
real      ,DIMENSION(:,:,:)   ,POINTER   :: smaxact
real      ,DIMENSION(:,:,:)   ,POINTER   :: rminact
integer   ,DIMENSION(:)       ,POINTER   :: stat_count_nocl
integer   ,DIMENSION(:)       ,POINTER   :: stat_count_nocc
real      ,DIMENSION(:)       ,POINTER   :: csp_z
real      ,DIMENSION(:)       ,POINTER   :: csp_z8w
real      ,DIMENSION(:)       ,POINTER   :: csp_dz8w
real      ,DIMENSION(:)       ,POINTER   :: csp_u
real      ,DIMENSION(:)       ,POINTER   :: csp_v
real      ,DIMENSION(:)       ,POINTER   :: csp_w
real      ,DIMENSION(:)       ,POINTER   :: csp_p
real      ,DIMENSION(:)       ,POINTER   :: csp_th
real      ,DIMENSION(:)       ,POINTER   :: csp_thv
real      ,DIMENSION(:)       ,POINTER   :: csp_thl
real      ,DIMENSION(:)       ,POINTER   :: csp_qv
real      ,DIMENSION(:)       ,POINTER   :: csp_qc
real      ,DIMENSION(:)       ,POINTER   :: csp_qi
real      ,DIMENSION(:)       ,POINTER   :: csp_ql
real      ,DIMENSION(:)       ,POINTER   :: csp_qf
real      ,DIMENSION(:)       ,POINTER   :: csp_qt
real      ,DIMENSION(:)       ,POINTER   :: csp_lwc
real      ,DIMENSION(:)       ,POINTER   :: csp_iwc
real      ,DIMENSION(:)       ,POINTER   :: csp_speqv
real      ,DIMENSION(:)       ,POINTER   :: csp_a_cl
real      ,DIMENSION(:)       ,POINTER   :: csp_rho
real      ,DIMENSION(:)       ,POINTER   :: csp_u2
real      ,DIMENSION(:)       ,POINTER   :: csp_v2
real      ,DIMENSION(:)       ,POINTER   :: csp_u2v2
real      ,DIMENSION(:)       ,POINTER   :: csp_w2
real      ,DIMENSION(:)       ,POINTER   :: csp_w3
real      ,DIMENSION(:)       ,POINTER   :: csp_wskew
real      ,DIMENSION(:)       ,POINTER   :: csp_uw
real      ,DIMENSION(:)       ,POINTER   :: csp_vw
real      ,DIMENSION(:)       ,POINTER   :: csp_wth
real      ,DIMENSION(:)       ,POINTER   :: csp_wthv
real      ,DIMENSION(:)       ,POINTER   :: csp_wthl
real      ,DIMENSION(:)       ,POINTER   :: csp_wqv
real      ,DIMENSION(:)       ,POINTER   :: csp_wqc
real      ,DIMENSION(:)       ,POINTER   :: csp_wqi
real      ,DIMENSION(:)       ,POINTER   :: csp_wql
real      ,DIMENSION(:)       ,POINTER   :: csp_wqf
real      ,DIMENSION(:)       ,POINTER   :: csp_wqt
real      ,DIMENSION(:)       ,POINTER   :: csp_uw_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_vw_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wth_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wthv_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wthl_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wqv_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wqc_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wqi_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wql_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wqf_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_wqt_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_sedfqc
real      ,DIMENSION(:)       ,POINTER   :: csp_sedfqr
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_cond
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_lw
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_sw
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_ls
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_pr
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_cond
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_ls
real      ,DIMENSION(:)       ,POINTER   :: csp_qcdt_pr
real      ,DIMENSION(:)       ,POINTER   :: csp_qcdt_sed
real      ,DIMENSION(:)       ,POINTER   :: csp_qrdt_sed
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_lshor
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_lshor
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_lsver
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_lsver
real      ,DIMENSION(:)       ,POINTER   :: csp_thdt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: csp_qvdt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: csp_udt_ls
real      ,DIMENSION(:)       ,POINTER   :: csp_vdt_ls
real      ,DIMENSION(:)       ,POINTER   :: csp_udt_lsver
real      ,DIMENSION(:)       ,POINTER   :: csp_vdt_lsver
real      ,DIMENSION(:)       ,POINTER   :: csp_udt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: csp_vdt_lsrlx
real      ,DIMENSION(:)       ,POINTER   :: csp_swupf
real      ,DIMENSION(:)       ,POINTER   :: csp_swdnf
real      ,DIMENSION(:)       ,POINTER   :: csp_lwupf
real      ,DIMENSION(:)       ,POINTER   :: csp_lwdnf
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_rs
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_sh
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_bu
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_tr
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_di
real      ,DIMENSION(:)       ,POINTER   :: csp_tke_sgs
real      ,DIMENSION(:)       ,POINTER   :: csp_w_c
real      ,DIMENSION(:)       ,POINTER   :: csp_thl_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qt_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qv_c
real      ,DIMENSION(:)       ,POINTER   :: csp_ql_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qf_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qc_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qi_c
real      ,DIMENSION(:)       ,POINTER   :: csp_qnc_c
real      ,DIMENSION(:)       ,POINTER   :: csp_thv_c
real      ,DIMENSION(:)       ,POINTER   :: csp_w2_c
real      ,DIMENSION(:)       ,POINTER   :: csp_aw_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awthl_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awqt_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awqv_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awql_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awqf_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awqc_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awqi_c
real      ,DIMENSION(:)       ,POINTER   :: csp_awthv_c
real      ,DIMENSION(:)       ,POINTER   :: csp_a_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_w_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_thl_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_qt_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_qv_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_ql_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_qf_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_qc_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_qi_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_thv_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_w2_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_aw_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awthl_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awqt_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awqv_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awql_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awqf_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awqc_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awqi_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_awthv_cc
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_thl
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_qt
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_ql
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_qf
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_qc
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_qi
real      ,DIMENSION(:)       ,POINTER   :: csp_sigc_thv
real      ,DIMENSION(:)       ,POINTER   :: csp_th2
real      ,DIMENSION(:)       ,POINTER   :: csp_thv2
real      ,DIMENSION(:)       ,POINTER   :: csp_thl2
real      ,DIMENSION(:)       ,POINTER   :: csp_qv2
real      ,DIMENSION(:)       ,POINTER   :: csp_smaxactmax
real      ,DIMENSION(:)       ,POINTER   :: csp_rminactmin
real      ,DIMENSION(:)       ,POINTER   :: csp_wmax
real      ,DIMENSION(:)       ,POINTER   :: csp_wmin
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_th
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_u
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_v
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_w
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_w2
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qv
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qc
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qr
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qi
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qs
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_qg
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_lwc
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_iwc
real      ,DIMENSION(:,:,:)   ,POINTER   :: csv_cldfrac
real      ,DIMENSION(:,:)     ,POINTER   :: css_lwp
real      ,DIMENSION(:,:)     ,POINTER   :: css_iwp
real      ,DIMENSION(:,:)     ,POINTER   :: css_cldtot
real      ,DIMENSION(:,:)     ,POINTER   :: css_cldlow
