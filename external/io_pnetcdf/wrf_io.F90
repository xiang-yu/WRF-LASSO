...
!     if(newFileName(i:i) == '-') newFileName(i:i) = '_'
 ...
 ! stat = NFMPI_CREATE(Comm, newFileName, IOR(NF_CLOBBER, NF_64BIT_DATA), info, DH%NCID) !21-07-11/XYLI.
...
!  stat = NFMPI_CREATE(Comm, FileName, IOR(NF_CLOBBER, NF_64BIT_DATA), info, DH%NCID) !21-07-11/XYLI.
  call mpi_info_free( info, ierr)
!
!!!!!!!!!!!!!!! 
#endif
