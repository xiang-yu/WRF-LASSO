...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % crm_zsfc                   = model_config_rec % crm_zsfc 
 grid % crm_lat                    = model_config_rec % crm_lat 
 grid % crm_lon                    = model_config_rec % crm_lon 
 grid % crm_stretch                = model_config_rec % crm_stretch 
 grid % crm_num_pert_layers        = model_config_rec % crm_num_pert_layers 
 grid % crm_pert_random_seed       = model_config_rec % crm_pert_random_seed 
 grid % crm_pert_amp               = model_config_rec % crm_pert_amp 
 grid % crm_init_ccn               = model_config_rec % crm_init_ccn 
 grid % crm_lupar_opt              = model_config_rec % crm_lupar_opt 
 grid % crm_znt                    = model_config_rec % crm_znt 
 grid % crm_emiss                  = model_config_rec % crm_emiss 
 grid % crm_thc                    = model_config_rec % crm_thc 
 grid % crm_mavail                 = model_config_rec % crm_mavail 
 grid % crm_force_opt              = model_config_rec % crm_force_opt 
 grid % crm_th_adv_opt             = model_config_rec % crm_th_adv_opt 
 grid % crm_th_rlx_opt             = model_config_rec % crm_th_rlx_opt 
 grid % crm_qv_adv_opt             = model_config_rec % crm_qv_adv_opt 
 grid % crm_qv_rlx_opt             = model_config_rec % crm_qv_rlx_opt 
 grid % crm_adj_uv_opt             = model_config_rec % crm_adj_uv_opt 
 grid % crm_uv_rlx_opt             = model_config_rec % crm_uv_rlx_opt 
 grid % crm_vert_adv_opt           = model_config_rec % crm_vert_adv_opt 
 grid % crm_wcpa_opt               = model_config_rec % crm_wcpa_opt 
 grid % crm_num_force_layers       = model_config_rec % crm_num_force_layers 
 grid % crm_tau_s                  = model_config_rec % crm_tau_s 
 grid % crm_tau_m                  = model_config_rec % crm_tau_m 
 grid % crm_flx_opt                = model_config_rec % crm_flx_opt 
 grid % crm_sh_flx                 = model_config_rec % crm_sh_flx 
 grid % crm_lh_flx                 = model_config_rec % crm_lh_flx 
 grid % crm_flx_ct                 = model_config_rec % crm_flx_ct 
 grid % crm_flx_psfcpa             = model_config_rec % crm_flx_psfcpa 
 grid % crm_albedo_opt             = model_config_rec % crm_albedo_opt 
 grid % crm_albedo                 = model_config_rec % crm_albedo 
 grid % crm_tsk_opt                = model_config_rec % crm_tsk_opt 
 grid % crm_tsk                    = model_config_rec % crm_tsk 
 grid % crm_ust_opt                = model_config_rec % crm_ust_opt 
 grid % crm_ust                    = model_config_rec % crm_ust 
 grid % crm_init_tke_opt           = model_config_rec % crm_init_tke_opt 
 grid % crm_init_tke               = model_config_rec % crm_init_tke 
 grid % crm_cgilsrad_re_opt        = model_config_rec % crm_cgilsrad_re_opt 
 grid % crm_morr_act_opt           = model_config_rec % crm_morr_act_opt 
 grid % crm_mp_nc                  = model_config_rec % crm_mp_nc 
 grid % crm_num_aer_layers         = model_config_rec % crm_num_aer_layers 
 grid % crm_morr_hygro_opt         = model_config_rec % crm_morr_hygro_opt 
 grid % crm_morr_hygro             = model_config_rec % crm_morr_hygro 
 grid % crm_stat_opt               = model_config_rec % crm_stat_opt 
 grid % crm_stat_sample_interval_s = model_config_rec % crm_stat_sample_interval_s 
